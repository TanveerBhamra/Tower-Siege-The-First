...
function setup() {
  ...
  world = engine.world;
  hexa = Matter.Bodies.circle(100, 100, 50, properties);
  ...
  sling =  new SlingShot(hexa, {x:100, y:100});
}
function draw() {
  background(56, 44, 44);
  ...
  block25.display();
  imageMode(CENTER);
  image(polygon_img, hexa.position.x , hexa.position.y, 100, 100);
  sling.display();
